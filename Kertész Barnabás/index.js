...
bot.on('guildMemberAdd', member => {
    member.guild.channels.get('830890690232844366').send("Welcome"); 
});

bot.on("guildMemberAdd", (member) => {
    const rulesChannel = "830890689898348610";
    const channelID = "830890690232844366";
...
if(cmd === `${prefix}work`){
    let cd_role_id = "830890689898348610";
...
if(cmd === `${prefix}report`){
    if(args[0] && message.mentions.members.first() && args[1]){
        ...
        let report_channel = "830890691579740237npm";
